...
class Costomerpanel extends StatefulWidget {
  const Costomerpanel ({super.key});
  @override
  CostomerpanelState createState() {
    return CostomerpanelState();
  }
}
class CostomerpanelState extends State<Costomerpanel > {
...
//  final TextEditingController  _brandController = new TextEditingController();
  ...
  Future<void> addUser() async {
    ...
    CollectionReference Bag = FirebaseFirestore.instance.
    collection('Bag');
    Bag.doc().set(
        {
          'name': name,
